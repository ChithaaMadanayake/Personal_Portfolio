  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        The following projects highlight my skills and experience in web development and cybersecurity. Each project includes a brief description along with links to source code and live demos. They demonstrate my ability to build secure, scalable solutions, work across multiple technologies, 
        and deliver high-quality results through real-world challenges.</p>
      </div>
